...
class BenchmarkOptionHandler(BasicOptionHandler):
    ...
    def add_options(self, parser):
        ...
        parser.add_argument('--level_max', type=float, default=None, help='Max level for octree truncation.')
        parser.add_argument('--scale', type=float, default=None, help='PC scaling option for the codec config.')
        return parser