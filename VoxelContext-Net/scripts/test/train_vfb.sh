...
TRAIN_DATA_CONFIG="${HOME_DIR}/config/data_config/vfb_oct_voxel_context.yaml train_cfg"
VAL_DATA_CONFIG="${HOME_DIR}/config/data_config/vfb_oct_voxel_context.yaml val_cfg"
DDP=False
